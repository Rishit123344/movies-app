...
export default class HomeScreen extends Component{
    ...
    timeConvert(num) {
      ...
      getMovie = () => {
        const url = "http://0cb0-2405-201-d003-707d-4caf-f9a3-8eb7-d26f.ngrok.io/get-movie";
        axios
          .get(url)
          .then(response => {
      ...
      likedMovie = () => {
        const url = "http://0cb0-2405-201-d003-707d-4caf-f9a3-8eb7-d26f.ngrok.io/liked-movie";
        axios
          .post(url)
          .then(response => {
            this.getMovie();
      ...
      unlikedMovie = () => {
        const url = "http://0cb0-2405-201-d003-707d-4caf-f9a3-8eb7-d26f.ngrok.io/unliked-movie";
        axios
          .post(url)
          .then(response => {
            this.getMovie();
      ...
      notWatched = () => {
        const url = "http://0cb0-2405-201-d003-707d-4caf-f9a3-8eb7-d26f.ngrok.io/did-not-watch";
        axios
          .post(url)
          .then(response => {
            this.getMovie();
